...
def hide():
    ...
    my_notebook2.hide(8)
    my_notebook2.hide(9)
    my_notebook2.hide(10)
    my_notebook2.hide(11)
    my_notebook2.hide(12)
    my_notebook2.hide(13)
    my_notebook2.hide(14)
    my_notebook2.hide(15)
    my_notebook2.hide(16)
    my_notebook2.hide(17)
    my_notebook2.hide(18)
    my_notebook2.hide(19)
    my_notebook2.hide(20)
    my_notebook2.hide(21)
    my_notebook2.hide(22)
    my_notebook2.hide(23)
    my_notebook2.hide(24)
...
my_img= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/Vowels.png'))
my_Label1 = Label(Vowels,image=my_img)
my_Label1.grid(row=2,column=0, sticky='w')

my_img2= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/Vowels.png'))
...
my_img3= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/K.png'))
my_Label3 = Label(kcolumn,image=my_img3)
my_Label3.grid(row=2,column=0, sticky='w')

my_img4= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/K.png'))
...
my_img5= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/S.png'))
my_Label5 = Label(scolumn,image=my_img5)
my_Label5.grid(row=2,column=0, sticky='w')

my_img6= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/S.png'))
...
my_img7= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/T.png'))
my_Label7 = Label(tcolumn,image=my_img7)
my_Label7.grid(row=2,column=0, sticky='w')

my_img8= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/T.png'))
...
my_img9= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/N.png'))
my_Label9 = Label(ncolumn,image=my_img9)
my_Label9.grid(row=2,column=0, sticky='w')

my_img10= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/N.png'))
...
my_img11= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/H.png'))
my_Label11 = Label(hcolumn,image=my_img11)
my_Label11.grid(row=2,column=0, sticky='w')

my_img12= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/H.png'))
...
my_img13= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/M.png'))
my_Label13 = Label(mcolumn,image=my_img13)
my_Label13.grid(row=2,column=0, sticky='w')

my_img14= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/M.png'))
...
my_img15= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/Y.png'))
my_Label15 = Label(ycolumn,image=my_img15)
my_Label15.grid(row=2,column=0, sticky='w')

my_img16= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/Y.png'))
...
my_img17= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/R.png'))
my_Label17 = Label(rcolumn,image=my_img17)
my_Label17.grid(row=2,column=0, sticky='w')

my_img18= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/R.png'))
...
my_img19= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Hiragana/W.png'))
my_Label19 = Label(wcolumn,image=my_img19)
my_Label19.grid(row=2,column=0, sticky='w')

my_img20= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Katakana/W.png'))
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
img= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 1.png'))
Label1 = Label(radical24,image=img)
Label1.grid(row=1,column=0, sticky='w')

imga= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 1-1.png'))
Label2 = Label(radical24,image=imga)
Label2.grid(row=1,column=2, sticky='w')
#end of Radical 1-24 tab

imgb= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 2.png'))
Label3 = Label(radical48,image=imgb)
Label3.grid(row=1,column=0, sticky='w')

imgc= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 2-1.png'))
Label4 = Label(radical48,image=imgc)
Label4.grid(row=1,column=2, sticky='w')
#end of Radical 25-48 tab

imgd= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 3.png'))
Label5 = Label(radical72,image=imgd)
Label5.grid(row=1,column=0, sticky='w')

imge= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 3-1.png'))
Label6 = Label(radical72,image=imge)
Label6.grid(row=1,column=2, sticky='w')
#end of Radical 49-72 tab

imgf= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 4.png'))
Label7 = Label(radical96,image=imgf)
Label7.grid(row=1,column=0, sticky='w')

imgg= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 4-1.png'))
Label8 = Label(radical96,image=imgg)
Label8.grid(row=1,column=2, sticky='w')
#end of Radical 73-96 tab

imgh= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 5.png'))
Label9 = Label(radical120,image=imgh)
Label9.grid(row=1,column=0, sticky='w')

imgi= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 5-1.png'))
Label10 = Label(radical120,image=imgi)
Label10.grid(row=1,column=2, sticky='w')
#end of Radical 97-120 tab

imgj= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 6.png'))
Label11 = Label(radical144,image=imgj)
Label11.grid(row=1,column=0, sticky='w')

imgk= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 6-1.png'))
Label12 = Label(radical144,image=imgk)
Label12.grid(row=1,column=2, sticky='w')
#end of Radical 121-144 tab

imgl= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 7.png'))
Label13 = Label(radical168,image=imgl)
Label13.grid(row=1,column=0, sticky='w')

imgm= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 7-1.png'))
Label14 = Label(radical168,image=imgm)
Label14.grid(row=1,column=2, sticky='w')
#end of Radical 145-168 tab

imgn= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 8.png'))
Label15 = Label(radical192,image=imgn)
Label15.grid(row=1,column=0, sticky='w')

imgo= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 8-1.png'))
Label16 = Label(radical192,image=imgo)
Label16.grid(row=1,column=2, sticky='w')
#end of Radical 169-192 tab

imgp= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 9.png'))
Label17 = Label(radical214,image=imgp)
Label17.grid(row=1,column=0, sticky='w')

imgq= ImageTk.PhotoImage(Image.open('C:/Learning App/images/Radicals/Kanji 9-1.png'))
